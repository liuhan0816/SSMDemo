...
;layui.define("form", function (e) {
    "use strict";
    var i = layui.$, a = layui.form, n = "treeaccount", r = {
        ...
        layui.each(l, function (a, l) {
            var c = l.children && l.children.length > 0,
                ...
                h = i(['<div data-id="' + l.id + '" class="layui-tree-set' + (l.spread ? " layui-tree-spread" : "") + (l.checked ? " layui-tree-checkedFirst" : "") + '">', "<div " + (r.drag && !l.fixed ? 'draggable="true"' : "") + ' class="layui-tree-entry">', '<div class="layui-tree-main">', function () {
                    return r.showLine ? c ? '<span class="layui-tree-iconClick layui-tree-icon"><i class="layui-icon ' + (l.spread ? "layui-icon-subtraction" : "layui-icon-addition") + '"></i></span><i class="layui-icon layui-icon-tabs"></i>&nbsp;&nbsp;' : '<span class="layui-tree-iconClick"><i class="layui-icon layui-icon-friends"></i></span>' : '<span class="layui-tree-iconClick"><i class="layui-tree-iconArrow ' + (c ? "" : t) + '"></i></span>'
                }(), function () {
